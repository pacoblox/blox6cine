...
<div class="container">
	...
	<div class="jumbotron">
	<h2 class="brandMessage">Pelicula Borrada</h2>
	<h6 class="brandMessage">Identificacion de la pelicula: </h6><?php echo $_POST["Id_Pelicula"]; ?> <br>
...
if ($conn){
    echo "connected";
    if(($result = sqlsrv_query($conn,"DELETE FROM Pelicula where (Id_Pelicula) =('$phpId_Pelicula')")) !== false){  
