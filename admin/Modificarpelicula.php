...
if ($conn){
    echo "connected";
    if(($result = sqlsrv_query($conn,"UPDATE Pelicula set Nombre_Pelicula ='$phpNombre_Pelicula', Duracion ='$phpDuracion', Categoria = '$phpCategoria', Descripcion = '$phpDescripcion', Tipo_Censura = '$phpTipo_Censura', Imagen = '$phpImagen', Precio ='$phpPrecio'  where (Id_Pelicula)=('$phpId_Pelicula')")) !== false){  
