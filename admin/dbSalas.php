		...
		while ($obj = sqlsrv_fetch_object( $result )) {
			echo '<form>';
				echo'<tr>';
					...
					echo '<td><input style="border: none" name="name"type="text" readonly value="'.$obj->Cantidad_AsientVIP.'" ></td>';
            echo '<td><input style="border: none" name="name"type="text" readonly value="'.$obj->Cantidad_AsientNorm.'" ></td>';
				echo '</tr>';
			echo '</form>';
		}
	}
