		...
		while ($obj = sqlsrv_fetch_object( $result )) {
			echo '<form>';
				echo'<tr>';
					...
					echo '<td><input style="border: none" name="name"type="text" readonly value="'.$obj->Id_Manager.'" ></td>';
					echo '<td><input style="border: none" name="name"type="text" readonly value="'.$obj->Ubicacion_Nombre.'" ></td>';
            echo '<td><input style="border: none" name="name"type="text" readonly value="'.$obj->Ubicacion_Telefono.'" ></td>';
            echo '<td><input style="border: none" name="name"type="text" readonly value="'.$obj->Id_Ciudad.'" ></td>';
            echo '<td><input style="border: none" name="name"type="text" readonly value="'.$obj->Ubicacion_direccion.'" ></td>';
				echo '</tr>';
			echo '</form>';
		}
	}
