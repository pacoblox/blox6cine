...
<div class="container">
	...
	<div class="jumbotron">
	<h2 class="brandMessage">Tanda Borrada</h2>
	<h6 class="brandMessage">Identificacion de la Tanda: </h6><?php echo $_POST["Id_tandas"]; ?> <br>
...
if ($conn){
    echo "connected";
    if(($result = sqlsrv_query($conn,"DELETE FROM Tandas where (Id_tandas) =('$phpId_tandas')")) !== false){  
