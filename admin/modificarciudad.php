...
<div class="container">
	...
	<div class="jumbotron">
        	...
        	<h2 class="brandMessage">Ciudad Modificada</h2>
	...
	<h6 class="brandMessage">Nombre Ciudad: </h6><?php echo $_POST["Nombre_Ciudad"]; ?><br>
...
if ($conn){
    echo "connected";
    if(($result = sqlsrv_query($conn,"UPDATE Ciudad set Id_Pais ='$phpId_Pais', Nombre_Ciudad ='$phpNombre_Ciudad', Zona_horaria = '$phpZona_horaria'  where (Id_Ciudad)=('$phpId_Ciudad')")) !== false){  
