...
<div class="container">
	...
	<div class="jumbotron">
	<h2 class="brandMessage">Pais Creado</h2>
	<h6 class="brandMessage">Nombre de Pais: </h6><?php echo $_POST["Nombre_Pais"]; ?> <br>
...
if ($conn){
    echo "connected";
    if(($result = sqlsrv_query($conn,"INSERT into Pais (Nombre_Pais) Values ('$phpNombre_Pais')")) !== false){  
